...
/*
	{
	  Token: Token{Type: IDENT|INT|BANG|MINUS|LPAREN, Literal: "foobar"}
		Expression: {}
	}
*/
...
// curToken: {Type: "IDENT", Literal: "foobar"}
func (p *Parser) parseIdentifier() ast.Expression {
	return &ast.Identifier{Token: p.curToken, Value: p.curToken.Literal}
}

// curToken: {Type: "INT", Literal: "15"}
...
// curToken: {Type: "TRUE|FALSE", Literal: "true|false"}
func (p *Parser) parseBoolean() ast.Expression {
	return &ast.Boolean{Token: p.curToken, Value: p.curTokenIs(token.TRUE)}
}

// parses all other prefix tokens
// curToken: {Type: "BANG|MINUS|LPAREN", Literal: "!"}
